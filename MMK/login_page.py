...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "MMK", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=100,y=300)
        label2= Label(self.frame1, text= "Where Hospitality Meets the Bay.", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
    ...
    def login_func(self):
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                connection=pymysql.connect(host="localhost", user="root", password="Sai@2004", database="mydata")
    ...
    def change_pass(self):
        if self.email_entry.get() == "" or self.sec_ques.get() == "Select" or self.new_pass.get() == "":
            ...
            try:
                connection = pymysql.connect(host="localhost", user="root", password="Sai@20045", database="mydata")
                cur = connection.cursor()
